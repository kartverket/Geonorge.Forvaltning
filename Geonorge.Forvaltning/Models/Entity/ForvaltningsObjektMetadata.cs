...
//CREATE POLICY "MetadataViewers" ON "public"."ForvaltningsObjektMetadata"

//AS PERMISSIVE FOR SELECT

//TO public

//USING ((EXISTS (SELECT* FROM users WHERE (users.organization = ANY("ForvaltningsObjektMetadata"."Viewers")))))